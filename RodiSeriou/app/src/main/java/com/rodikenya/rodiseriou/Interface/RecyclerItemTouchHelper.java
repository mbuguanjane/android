package com.rodikenya.rodiseriou.Interface;
...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public void clearView(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        {
            View foregroundview=((FavouriteAdaptor.FavouriteViewHolder)viewHolder).view_foreground;
            getDefaultUIUtil().clearView(foregroundview);
        }else if(viewHolder instanceof CartAdaptor.CartViewholder)
        {
            View foregroundview=((CartAdaptor.CartViewholder)viewHolder).view_foreground;
            getDefaultUIUtil().clearView(foregroundview);
        }
    }
