...
public class TrainingOrderViewHolder extends RecyclerView.ViewHolder implements  View.OnClickListener{
    public TextView order_id,order_price,order_address,order_comment;


  IItemClickListener itemClickListener;
    public TrainingOrderViewHolder(@NonNull View itemView) {
        super(itemView);
