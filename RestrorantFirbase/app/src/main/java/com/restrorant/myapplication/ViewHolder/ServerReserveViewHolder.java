...
public class ServerReserveViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
        ,
        View.OnCreateContextMenuListener
{
    ...
    public ServerReserveViewHolder(@NonNull View itemView) {
        super(itemView);
